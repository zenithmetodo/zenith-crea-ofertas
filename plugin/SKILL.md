---
name: crea-ofertas-1pct
description: Mega-skill TOP 1% para crear OFERTAS COMPLETAS de alto valor percibido. Orquesta 26 sub-agentes especializados (cada uno crack de UNA cosa) que construyen, palabra por palabra, todo el embudo de la oferta — desde el Punto A→B del cliente, pasando por 4 variantes de One Belief (con identidad vs anti-identidad), mecanismo del problema, mecanismo de la solución, nombre chicle, características → beneficios → deseos, promesa ganadora, garantía impresionante, módulos y clases con la fórmula carta-de-ventas-invisible, bonus irresistibles, hasta la maximización del valor percibido con la fórmula Bencivenga (Beneficio + Credibilidad − Costo). Aplica los frameworks canónicos del direct response (Schwartz 5 niveles de consciencia + sofisticación, Masterson + Forde Great Leads, Bencivenga, Halbert, Sugarman, Brunson, Albuquerque, Todd Brown). Entrega cada pieza en una carpeta con HTML estético imprimible a PDF. Triggers: "crea mi oferta", "diseña la oferta completa", "one belief", "mecanismo", "promesa ganadora", "bonus irresistibles", "valor percibido", "carta de ventas invisible", "auditor de oferta", "estructura mi producto", "incuba mi producto perfecto".
---

# CREA OFERTAS 1% · Orquestador Maestro
